package com.justdarwin.android.popularmovies.data;
...
/**
 * Created by darwin on 15/07/17.
 */

public class MovieContract {

    public static final String CONTENT_AUTHORITY = "com.justdarwin.android.popularmovies";
